    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-600">Ładowanie szczegółów dokumentu...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm font-medium text-gray-900">Dokument nie został znaleziony</p>
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <nav className="flex items-center gap-2 text-sm text-gray-500 mb-4">
            <Link to="/cases" className="hover:text-gray-700">
              Sprawy
            </Link>
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
            <Link to={`/cases/${caseId}`} className="hover:text-gray-700">
              Szczegóły sprawy
            </Link>
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
            <span className="text-gray-900">Szczegóły dokumentu</span>
          </nav>
          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-start gap-4 flex-1 min-w-0">
              ...
              <div className="flex-1 min-w-0">
                <h1 className="text-2xl font-bold text-gray-900 truncate" title={document.filename}>
                  {document.filename}
                </h1>
                <div className="mt-2 flex items-center gap-4 text-sm text-gray-600">
                  <span>{formatFileSize(document.file_size)}</span>
                  <span>•</span>
                  <span>Przesłano {document.uploaded_at ? formatRelativeTime(document.uploaded_at) : 'niedawno'}</span>
                  <span>•</span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {document.status === 'completed' && (
              <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6">
                <h2 className="text-lg font-semibold text-gray-900 mb-4">Metadane dokumentu</h2>
                <dl className="grid grid-cols-2 gap-4">
                  <div>
                    <dt className="text-sm font-medium text-gray-500">Liczba stron</dt>
                    <dd className="mt-1 text-sm font-semibold text-gray-900">
                      {documentData?.page_count || 'N/A'}
                    </dd>
                  </div>
                  <div>
                    <dt className="text-sm font-medium text-gray-500">Fragmenty semantyczne</dt>
                    <dd className="mt-1 text-sm font-semibold text-gray-900">
                      {document.total_chunks || 0}
                    </dd>
                  </div>
                  <div>
                    <dt className="text-sm font-medium text-gray-500">Data przesłania</dt>
                    <dd className="mt-1 text-sm font-semibold text-gray-900">
                  ...
                  {document.completed_at && (
                    <>
                      ...
                      <div>
                        <dt className="text-sm font-medium text-gray-500">Czas przetwarzania</dt>
                        <dd className="mt-1 text-sm font-semibold text-gray-900">
          ...
          <div className="space-y-8">
            ...
            {/* Quick actions */}
            <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6">
              <h3 className="text-sm font-medium text-gray-900 mb-4">Szybkie akcje</h3>
              <div className="space-y-2">
                <button className="w-full text-left px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 rounded-md transition-colors flex items-center gap-2">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
